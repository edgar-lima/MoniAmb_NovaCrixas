...
ggsave(filename = "Jack_meses.tiff", width = 48, height = 22, units = "cm", dpi = 200)
...
ggsave(filename = "Jack_juntos.tiff", width = 48, height = 22, units = "cm", dpi = 200)
```
...
ggsave(filename = "CA_Marco.tiff", width = 48, height = 22, units = "cm", dpi = 200)
...
ggsave(filename = "CA_Junho.tiff", width = 48, height = 22, units = "cm", dpi = 200)
```
...
ggsave(filename = "CA_Juntos.tiff", width = 48, height = 22, units = "cm", dpi = 200)
```
